module github.com/vanshcodes/go-netflix-backend
...
require (
	...
	github.com/Kamva/nautilus v0.1.10 // indirect
	github.com/Kamva/octopus v0.2.9 // indirect
	github.com/Kamva/shark v0.2.4 // indirect
